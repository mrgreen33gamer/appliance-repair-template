...
// FixFirst Appliance Repair — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Refrigerator Repair', 'Washer & Dryer Repair', 'Oven & Range Repair',
  'Dishwasher Repair', 'Microwave Repair', 'Maintenance Plans',
  'Free Diagnostic', 'Other / Not Sure',
];
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 790-8800. We answer 7 days a week including evenings. For a genuine urgent appliance failure in Central Texas, call — don't wait on a form response.",
  },
  {
    question: 'How quickly can someone come out?',
    answer: "Same-day diagnostics are available most days. Same-week service is available most days during business hours. Evening and weekend emergency calls are dispatched within 1–2 hours. We'll give you an honest ETA when you call — not a vague arrival window.",
  },
  {
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@fixfirstappliance.com',
                  href:      'mailto:hello@fixfirstappliance.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '2412 Franklin Ave, Waco TX 76701',
                  href:      'https://maps.google.com/?q=4521+Bosque+Blvd+Waco+TX+76701',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose FixFirst</p>
              {[
                'Upfront pricing — written quote before we start',
                '1-year parts & labor warranty on every repair',
                'factory-trained techs only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed FixFirst electrician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12547908800">(254) 790-8800</a>.
                  </p>
                ...
                <motion.div key="form" className={styles.formCard}
                  ...
                  <div className={styles.formCardHeader}>
                    ...
                    <div>
                      <h2 className={styles.formTitle}>Request Service or a Book Service</h2>
      ...
      <CTABanner
        ...
        subline="Call (254) 790-8800 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 790-8800"
        primaryLink="tel:+12547908800"
        secondaryText="Send a Text"
        secondaryLink="sms:+12547908800"
      />
