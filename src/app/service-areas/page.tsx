...
// FixFirst Appliance Repair — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full refrigerator, laundry, cooking, dishwasher, and microwave repair across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full appliance coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Appliance repairs'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same upfront pricing and 90-Day Repair Warranty as every other area we cover.",
    highlights:  ['Upfront pricing', '90-Day Repair Warranty', 'factory-trained'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable appliance service for Bellmead residents and businesses. Appliance repairs, repairs, and lighting installs — same-day when available.',
    highlights:  ['Residential & commercial', 'factory-trained electricians', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential appliance service for the China Spring area. We make the drive — upfront pricing applies just the same.',
    highlights:  ['Rural coverage', 'Upfront pricing', 'Emergency available'],
  },
  {
    city:        'McGregor',
    slug:        'mcgregor-tx',
    ...
    highlights:  ['Shop & residential', 'Appliance repairs', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service appliance coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial appliance service.',
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Upfront pricing, factory-trained electricians, and a 90-Day Repair Warranty — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12547908800" className={styles.heroCTAPrimary}>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12547908800" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12547908800" className={styles.unlistedCTA}>
            Call (254) 790-8800
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Upfront pricing, 90-Day Repair Warranty, no contracts ever."
        primaryText="Call (254) 790-8800"
        primaryLink="tel:+12547908800"
        secondaryText="Get a Book Service"
