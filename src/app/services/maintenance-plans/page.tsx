// FixFirst Appliance Repair — Maintenance Plans Service Page
"use client";
...
export default function ServicePage() {
  ...
  const whyFeatures = [
    { icon: faClock, title: "Same-Day When Possible", description: "Most maintenance plans calls in Waco can be scheduled same-day when parts and routing allow." },
  ...
  const localAreas = [
    { town: "Waco",         benefit: "Home base — fastest scheduling for maintenance plans.", badge: "Home Base" },
  ...
  const faq = [
    { question: "What is included in a FixFirst maintenance plan?", answer: "Priority scheduling, seasonal multi-appliance inspections, documented findings, and member pricing on repairs." },
    { question: "Is this a long-term contract?", answer: "No long-term lock-ins. Plans are simple and cancel-friendly — we keep you because the service works." },
    { question: "Good for rental properties?", answer: "Yes — property managers use plans to cut emergency after-hours failures across units." },
    { question: "Which appliances can be covered?", answer: "Refrigerators, washers, dryers, ovens/ranges, dishwashers, and microwaves — residential and light commercial." },
    { question: "Do members get same-day priority?", answer: "Members get priority routing when same-day slots open." },
    { question: "How do I enroll?", answer: "Call (254) 790-8800 or book online — we will recommend a plan size for your home or portfolio." },
  ];
  ...
  const crossServices = [
    {
        ...
        body: "Cover cooling failures before food loss.",
        link: "/services/refrigerator-repair"
    },
    {
        icon: faShirt,
        title: "Washer & Dryer Repair",
        body: "Keep laundry day from becoming laundry week.",
        link: "/services/washer-dryer-repair"
    },
    {
        icon: faFireBurner,
        title: "Oven & Range Repair",
        body: "Cooking appliances on the plan get priority.",
        link: "/services/oven-range-repair"
    },
    {
        icon: faSink,
        title: "Dishwasher Repair",
        body: "Prevent drain and pump failures with checkups.",
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Maintenance Plans in Waco, TX"
        subtitle="Priority scheduling, seasonal inspections, and documented service visits that reduce emergency breakdowns for busy homes and property portfolios."
      />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="services/maintenance-plans" title="Maintenance Plans Across Central Texas" /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title="Maintenance Plans FAQs" /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title="Request Maintenance Plans" cityName="Waco" slug="services/maintenance-plans" spot="service-maintenance-plans-form" formVariant={2} />
      </div>
    </main>
  );
}
