// FixFirst Appliance Repair — Dishwasher Repair Service Page
"use client";
...
export default function ServicePage() {
  ...
  const whyFeatures = [
    { icon: faClock, title: "Same-Day When Possible", description: "Most dishwasher repair calls in Waco can be scheduled same-day when parts and routing allow." },
  ...
  const localAreas = [
    { town: "Waco",         benefit: "Home base — fastest scheduling for dishwasher repair.", badge: "Home Base" },
  ...
  const faq = [
    { question: "Why is my dishwasher not cleaning well?", answer: "Filters, spray arms, inlet valves, and wash pumps are common. We diagnose before recommending parts." },
    { question: "Standing water in the bottom — can you fix it same day?", answer: "Often yes when the drain pump or hose is the issue and parts are on the truck." },
    { question: "Do you install new dishwashers too?", answer: "We focus on repair. If replacement is smarter, we will say so and can recommend next steps." },
    { question: "Is hard water a problem in Waco?", answer: "Yes — mineral buildup is common. We address scale-related failures and maintenance tips." },
    { question: "Brands covered?", answer: "Bosch, KitchenAid, Whirlpool, GE, Samsung, LG, Maytag, and more." },
    { question: "Warranty length?", answer: "90 days on completed repair parts and labor." },
  ];
  ...
  const crossServices = [
    {
        ...
        body: "Full kitchen appliance support under one company.",
        link: "/services/refrigerator-repair"
    },
    {
        icon: faFireBurner,
        title: "Oven & Range Repair",
        body: "Cooking appliance repairs by the same local team.",
        link: "/services/oven-range-repair"
    },
    {
        icon: faShirt,
        title: "Washer & Dryer Repair",
        body: "Laundry repairs scheduled around your day.",
        link: "/services/washer-dryer-repair"
    },
    {
        icon: faClipboardList,
        title: "Maintenance Plans",
        body: "Fewer surprise failures with planned service.",
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Dishwasher Repair in Waco, TX"
        subtitle="Standing water, gritty dishes, odd smells, and drain failures — dishwasher repair that restores quiet, clean results."
      />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="services/dishwasher-repair" title="Dishwasher Repair Across Central Texas" /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title="Dishwasher Repair FAQs" /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title="Request Dishwasher Repair" cityName="Waco" slug="services/dishwasher-repair" spot="service-dishwasher-repair-form" formVariant={2} />
      </div>
    </main>
  );
}
