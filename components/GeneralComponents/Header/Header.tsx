...
const logoName = 'FixFirst';
const logoTagline = 'Repair · All Brands · Same-Day';
const navLinks = [
  { href: '/', label: 'Home' },
...
const phoneDisplay = '(254) 790-8800';
const phoneHref = 'tel:+12547908800';
const ctaLabel = 'Book Service';
