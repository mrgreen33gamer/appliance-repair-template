...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: '90-Day Repair Warranty',            us: true,  others: false },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'FixFirst vs. The Other Guys' }: ValueComparisonProps) {
  return (
    <section className={styles.section} aria-label="Value comparison">
      <div className={styles.container}>
        ...
        >
          ...
          <a href="/contact" className={styles.stripCta}>Get Your Book Service →</a>
        </motion.div>
