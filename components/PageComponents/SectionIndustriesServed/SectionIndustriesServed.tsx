...
const INDUSTRIES = [
  ...
  { slug: 'multifamily', label: 'Multifamily Housing', icon: faCity },
  { slug: 'hospitality', label: 'Hospitality & Restaurants', icon: faUtensils },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Appliance repair programs — built for how your industry actually works.',
  disableLinks = false,
