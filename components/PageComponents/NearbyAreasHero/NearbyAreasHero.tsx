...
export default function NearbyAreasHero({
  ...
  const displayDesc     = description ??
    `FixFirst Appliance Repair provides fast, reliable appliance service to ${cityName} and all surrounding communities. Licensed technicians, upfront pricing, 2-year warranty on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12547908800" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
