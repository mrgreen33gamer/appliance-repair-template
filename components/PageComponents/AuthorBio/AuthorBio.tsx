...
const personSchema = {
  ...
  worksFor: {
    ...
    url: "https://www.fixfirstappliance.com",
  },
  url: "https://www.fixfirstappliance.com/about",
  sameAs: [
    "https://www.facebook.com/brightvoltelectric",
    "https://www.fixfirstappliance.com",
  ],
  knowsAbout: [
    "Electrical Refrigerator Repair", "Washer & Dryer", "Oven & Range",
    "Dishwasher", "Maintenance Plans", "Central Texas Appliance Repair",
  ],
  description:
    "Owner of FixFirst Appliance Repair in Waco, TX. factory-trained technician with 16+ years repairing appliances for Central Texas homes and businesses. Upfront pricing, 90-Day Repair Warranty.",
};

const AuthorBio: React.FC<AuthorBioProps> = ({
  cityName,
  imageSrc = "/pages/home/welcome/hero-main.jpg",
  imageAlt = "Nadia Patel - Owner of FixFirst Appliance Repair",
}) => {
    ...
    <section className={styles.authorBio} aria-label="About the Author">
      ...
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          <p className={styles.role}>Owner & Lead Technician · FixFirst Appliance Repair</p>
          <h2 className={styles.title}>Nadia Patel</h2>

          <p className={styles.description}>
            16+ years as a factory-trained technician serving Central Texas
          ...
          <div className={styles.footer}>
            <a
              ...
              aria-label="Connect with FixFirst Appliance Repair on Facebook"
              onClick={() => trackEvent({
                eventType:    'click',
