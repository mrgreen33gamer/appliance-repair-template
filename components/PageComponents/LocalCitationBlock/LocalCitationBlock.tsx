...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'FixFirst Appliance Repair',
  address       = '2412 Franklin Ave, Waco, TX 76701',
  phone         = '(254) 790-8800',
  email         = 'hello@fixfirstappliance.com',
  googleMapsUrl = 'https://maps.google.com/?q=FixFirst+Electric+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with factory-trained technicians.
          </p>
        </div>
