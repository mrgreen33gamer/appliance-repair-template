  ...
  const initMap = () => {
    ...
    currentMap.on('load', () => {
      ...
      new mapboxgl.Marker({ element: hqEl, anchor: 'center' })
        ...
        .setPopup(new mapboxgl.Popup().setHTML('<strong>FixFirst Appliance Repair HQ</strong><br>2412 Franklin Ave, Waco, TX 76701'))
        .addTo(currentMap);
  ...
  return (
    <section ref={sectionRef} className={styles.mapSection}>
      ...
      <div className={styles.mapLegend}>
        <div><span className={styles.hqDot} /> FixFirst Appliance Repair HQ – Waco</div>
