...
import {
  ...
  faSnowflake, faShirt, faFireBurner, faSink, faMicrochip,
  faClipboardList, faBolt, faWrench,
        ...
        <div className={styles.card}>
          ...
          <div className={styles.leftPanel}>
            <div className={styles.panelInner}>
              ...
              <span className={styles.quoteAttrib}>— FixFirst Windows & Doors, Waco TX</span>
              ...
              <div className={styles.panelBadges}>
                {['Same-Day Available', '10-Year Install Warranty', 'No Contracts', 'Factory-Trained'].map(b => (
