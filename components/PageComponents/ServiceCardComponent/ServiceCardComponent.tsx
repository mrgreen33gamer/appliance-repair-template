...
export default function ServiceCardComponent({
  cards,
  heading    = 'Appliance Repair Services for Appliance Repair',
  subheading = 'From full appliance repairs to washers and dryers and maintenance plans, FixFirst handles it all — on time, on price.',
