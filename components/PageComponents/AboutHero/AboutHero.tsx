      ...
      <div className={styles.heroContainer}>
        ...
        >
          ...
          <h1 className={styles.heroTitle}>
            Central Texas Appliance Repair<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            FixFirst Appliance Repair has been upgrading homes and businesses in{' '}
            <strong>{cityName}</strong> and across Central Texas for over 15 years —
            with licensed technicians, upfront pricing, and a warranty on every single job.
          </p>
          ...
          <div className={styles.imageFrame}>
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>FixFirst Appliance Repair</span>
                <span className={styles.trustCardSub}>Waco's Most Trusted Appliance Repair Company</span>
              </div>
            </div>
          </div>
        </motion.div>
